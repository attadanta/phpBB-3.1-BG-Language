...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_ALREADY_ACTIVATED'		=> 'Профилът Ви е вече активиран.',
	'ACCOUNT_DEACTIVATED'			=> 'Профилът Ви е деактивиран и може да бъде активиран отново само от администратор.',
	...
	'AJAX_ERROR_TEXT'				=> 'Грешка при обработката на заявката.',
	...
	'AJAX_ERROR_TEXT_PARSERERROR'	=> 'Невалиден отговор от сървъра при обработка на заявката.',
	'ALLOWED'						=> 'Позволен',
	...
	'ATTACHED_IMAGE_NOT_IMAGE'		=> 'Изображението, което прикачихте, е невалидно.',
	'AUTHOR'						=> 'Автор',
	'AUTH_NO_PROFILE_CREATED'		=> 'Профилът не беше създаден успешно.',
	'AUTH_PROVIDER_OAUTH_ERROR_INVALID_ENTRY'				=> 'Невалиден запис в базата данни.',
	'AUTH_PROVIDER_OAUTH_ERROR_INVALID_SERVICE_TYPE'		=> 'Посочен е невалиден тип на услугата.',
	...
	'AUTH_PROVIDER_OAUTH_TOKEN_ERROR_NOT_STORED'			=> 'OAuth токенът не е записан.',
	'AUTH_PROVIDER_OAUTH_TOKEN_ERROR_INCORRECTLY_STORED'	=> 'OAuth токенът е записан неправилно.',
	'AVATAR_DISALLOWED_CONTENT'		=> 'Прикаченият файл беше отхвърлен, защото е идентифициран като потенциална заплаха.',
	'AVATAR_DISALLOWED_EXTENSION'	=> 'Файлът не може да бъде показан, защото ползва забраненото разширение <strong>%s</strong>.',
	'AVATAR_EMPTY_REMOTE_DATA'		=> 'Посоченият аватар не може да бъде качен, защото файлът е невалиден.',
	'AVATAR_EMPTY_FILEUPLOAD'		=> 'Каченият аватар е празен.',
	'AVATAR_INVALID_FILENAME'		=> 'Посоченото име на файла %s е невалидно.',
	'AVATAR_NOT_UPLOADED'			=> 'Аватарът не може да бъде качен.',
	'AVATAR_NO_TEMP_DIR'			=> 'Папката за качане не може да бъде намерена или достъпена за запис.',
	'AVATAR_NO_SIZE'				=> 'Моля, въведете ширината и височината на аватара, тъй като не могат да бъдат определени автоматично.',
	'AVATAR_PARTIAL_UPLOAD'			=> 'Избраният файл беше качен частично.',
	...
	'AVATAR_PHP_UPLOAD_STOPPED'		=> 'Качването на файла беше спряно от разширение на PHP.',
	'AVATAR_URL_INVALID'			=> 'Посоченият адрес е невалиден.',
	'AVATAR_URL_NOT_FOUND'			=> 'Посоченият файл не е намерен.',
	...
	'BACK_TO_TOP'			=> 'Чело',
	'BACK_TO_PREV'			=> 'Предишна страница',
	'BAN_TRIGGERED_BY_EMAIL'=> 'Потребителят с този мейл адрес е изгонен от форума.',
	...
	'BBCODE_GUIDE'			=> 'Упътване за форматирането',
	'BCC'					=> 'BCC',
	'BIRTHDAYS'				=> 'Рождени дни',
	'BOARD_BAN_PERM'		=> 'Вие сте изгонен/а от този форум.<br /><br />Моля, свържете се с %2$sадминистратора на форума%3$s за повече информация.',
	'BOARD_BAN_REASON'		=> 'Причина за изгонването: <strong>%s</strong>',
	'BOARD_BAN_TIME'		=> 'Вие сте изгонен/а от форума до <strong>%1$s</strong>.<br /><br />Моля, свържете се с %2$sадминистратора на форума%3$s за повече информация.',
	'BOARD_DISABLE'			=> 'Форумът е временно недостъпен.',
	'BOARD_DISABLED'		=> 'Форумът е временно изключен.',
	'BOARD_UNAVAILABLE'		=> 'Форумът е временно недостъпен. Моля, опитайте по-късно.',
	'BROWSING_FORUM'		=> 'Форумът се разглежда от: %1$s',
	'BROWSING_FORUM_GUESTS'	=> array(
		1	=> 'Форумът се разглежда от: %2$s и %1$d гост',
		2	=> 'Форумът се разглежда от: %2$s и %1$d гости',
	),
	'BUTTON_EDIT'			=> 'Промени',
	...
	'CANCEL'				=> 'Откажи',
	'CHANGE'				=> 'Промени',
	'CHANGE_FONT_SIZE'		=> 'Промени големината на шрифта',
	'CHANGING_PREFERENCES'	=> 'Смяна на форумните настойки',
	'CHANGING_PROFILE'		=> 'Смяна на потребителските настройки',
	'CHARACTERS'			=> array(
		1	=> '%d символ',
		2	=> '%d символа',
	),
	...
	'CONFIRM_CODE_EXPLAIN'	=> 'Въведете кода както е показан без значение с малки или големи букви.',
	'CONFIRM_CODE_WRONG'	=> 'Въведеният код за потвърждение е неверен.',
	'CONFIRM_OPERATION'		=> 'Моля, потвърдете изпълнението на това действие.',
	...
	'COOKIE_CONSENT_INFO'	=> 'Научете повече',
	'COOKIE_CONSENT_MSG'	=> 'Този сайт използва бисквитки, за да направи ползването му максимално удобно.',
	'COOKIE_CONSENT_OK'		=> 'Ясно!',
	'COOKIES_DELETED'		=> 'Всички бисквитки за форума бяха изтрити.',
	'CURRENT_TIME'			=> 'Часът е %s',
	...
	'DISPLAY_MESSAGES'		=> 'Покажи предните съобщения',
	'DISPLAY_POSTS'			=> 'Покажи предите мнения',
	'DISPLAY_TOPICS'		=> 'Покажи предните теми',
	'DOWNLOADED'			=> 'Свалени',
	...
	'EDIT_POST'							=> 'Редактирай мнението',
	'ELLIPSIS'							=>	'…',
	'EMAIL'								=> 'Мейл', // Short form for EMAIL_ADDRESS
	'EMAIL_ADDRESS'						=> 'Мейл адрес',
	'EMAIL_INVALID_EMAIL'				=> 'Мейлът, който въведохте, е невалиден.',
	'EMAIL_SMTP_ERROR_RESPONSE'			=> 'Възникна проблем при изпращането на мейла на <strong>Ред %1$s</strong>. Отговор: %2$s.',
	'EMPTY_SUBJECT'						=> 'Публикуването на тема изисква посочване на тема.',
	'EMPTY_MESSAGE_SUBJECT'				=> 'Публикуването на съобщение изисква посочване на тема.',
	'ENABLED'							=> 'Разреши',
	'ENCLOSURE'							=> 'Приложение',
	'ENTER_USERNAME'					=> 'Въведете потребителско име',
	'ERR_CHANGING_DIRECTORY'			=> 'Директорията не беше сменена успешно.',
	'ERR_CONNECTING_SERVER'				=> 'Грешка при свързването със сървъра.',
	'ERR_JAB_AUTH'						=> 'Неуспешна ауторизация с Jabber сървъра.',
	...
	'ERR_WRONG_PATH_TO_PHPBB'			=> 'Посоченият път към phpBB е грешен.',
	'ERROR'									=> 'Грешка',
	...
	'FEATURE_NOT_AVAILABLE' => 'Посочената функция не е включена в този форум.',
	...
	'FILE_JSON_DECODE_ERR'	=> '%s не е правилно форматиран json файл',
	'FILE_NOT_FOUND'		=> 'Посоченият файл не може да бъде намерен: %s',
	'FIND_USERNAME'			=> 'Търси по потребителско име',
	'FOLDER'				=> 'Папка',
	...
	'FORUM_INDEX'			=> 'Челна страница',
	'FORUM_LINK'			=> 'Връзка към форума',
	'FORUM_LOCATION'		=> 'Адрес на форума',
	'FORUM_LOCKED'			=> 'Форумът е заключен',
	'FORUM_RULES'			=> 'Правила на форума',
	'FORUM_RULES_LINK'		=> 'Моля, прочетете правилата на форума',
	'FROM'					=> 'от',
	'FSOCK_DISABLED'		=> 'Операцията не може да бъде изпълнена, защото функцията <var>fsockopen</var> е изключена или търсеният сървър не може да бъде намерен.',
	'FSOCK_TIMEOUT'			=> 'Проблем при обработката на мрежовия поток.',
	...
	'FTP_FSOCK_ROOT_PATH_EXPLAIN'	=> 'Пътят към основната директория на phpBB форума.',
	'FTP_FSOCK_TIMEOUT'				=> 'FTP таймаут',
	'FTP_FSOCK_TIMEOUT_EXPLAIN'		=> 'Времето, в секунди, което системата ще изчаква за отговор от сървъра, измерено в секунди.',
	...
	'FTP_ROOT_PATH_EXPLAIN'		=> 'Пътят към основната директория на phpBB форума.',
	'FTP_TIMEOUT'				=> 'FTP таймаут',
	'FTP_TIMEOUT_EXPLAIN'		=> 'Времето, в секунди, което системата ще изчаква за отговор от сървъра, измерено в секунди.',
	...
	'GROUP_ERR_USERNAME'		=> 'Избрана е неподходяща група.',
	'GROUP_ERR_USER_LONG'		=> 'Името на групата не може е по-дълго от 60 символа. Избраното име е твърде дълго.',
	'GUEST'						=> 'Гост',
	'GUEST_USERS_ONLINE'		=> array(
		1	=> 'Има %d гост на линия',
		2	=> 'Има %d гости на линия',
	),
	...
	'IF'						=> 'Ако',
	'IMAGE'						=> 'Изображение',
	'IMAGE_FILETYPE_INVALID'	=> 'Изображенията с тип %d за mimetype %s не се поддържат.',
	'IMAGE_FILETYPE_MISMATCH'	=> 'Несъответствие на типа на изображението: получен е %2$s вместо %1$s.',
	'IN'						=> 'в',
	'INACTIVE'					=> 'Неактивен',
	'INDEX'						=> 'Показалец',
	...
	'IP'						=> 'IP',
	'IP_BLACKLISTED'			=> 'Вашият IP адрес %1$s е в черния списък. За повече информация, моля посетете <a href="%2$s">%2$s</a>.',

	'JABBER'				=> 'Jabber',
	'JOINED'				=> 'Регистриран',
	'JUMP_PAGE'				=> 'Моля, посочете страницата, на която искате да отидете',
	'JUMP_TO'				=> 'Отиди на',
	...
	'LDAP_NO_LDAP_EXTENSION'			=> 'Разширението LDAP не е налично.',
	'LDAP_NO_SERVER_CONNECTION'			=> 'Неуспешно свързване с LDAP сървъра.',
	'LDAP_SEARCH_FAILED'				=> 'Възникна грешка при търсенето в LDAP директорията.',
	'LEGEND'							=> 'Легенда',
	'LIVE_SEARCHES_NOT_ALLOWED'			=> 'Постоянното търсене не е позволено.',
	'LOADING'							=> 'Зареждане',
	...
	'LOGIN_CONFIRM_EXPLAIN'				=> 'За възпрепятстване на неоторизирания достъп до Вашите данни форумът изисква да въведете кода за потвърждение след няколко неуспешни опита за вход. Кодът е изписан на изображението по-долу. Ако имате зрително увреждане или не виждате кода поради друга причина, моля свържете се с %sBoard Administrator%s.', // unused
	'LOGIN_ERROR_ATTEMPTS'				=> 'Превишихте броя на позволените опити за вход. Заедно потребителското Ви име и парола ще трябва да въведете и показания долу код.',
	'LOGIN_ERROR_EXTERNAL_AUTH_APACHE'	=> 'Вашата самоличност не е потвърдена от Apache.',
	'LOGIN_ERROR_OAUTH_SERVICE_DOES_NOT_EXIST'	=> 'Посочена а несъществуваща OAuth услуга.',
	'LOGIN_ERROR_PASSWORD'				=> 'Въведохте неправилна парола. Моля, проверете паролата и опитайте отново. Ако проблемът продължава, моля свържете се с %sBoard Administrator%s.',
	'LOGIN_ERROR_PASSWORD_CONVERT'		=> 'Конверирането на паролата Ви не бе невъзможно при осъвременяването на форумния софтуер. Моля, %srequest a new password%s. Ако проблемът продължава, моля свържете се с %sBoard Administrator%s.',
	'LOGIN_ERROR_USERNAME'				=> 'Въведохте неправилно потребителско име. Моля, проверете го и опитайте отново. Ако проблемът продължава, моля свържете се с %sBoard Administrator%s.',
	'LOGIN_FORUM'						=> 'За да разглеждате и публикувате мнения в този форум, трябва да въвдетете парола.',
	'LOGIN_INFO'						=> 'За да влезете във форумите, е необходима регистрация. Регистрацията отнема само няколко минути, но Ви дава разширени възможности. Администраторите на форума могат също така да разрешат допълнителни дейтвия на регистрираните потребители. Преди да се регистрирате, моля уверете се, че сте се запознали с правилата на форума',
	'LOGIN_VIEWFORUM'					=> 'Този форум изисква регистрация.',
	'LOGIN_EXPLAIN_EDIT'				=> 'За да променяте мнения в този форум, трябва да сте влезли в профила си.',
	'LOGIN_EXPLAIN_VIEWONLINE'			=> 'За да видите листа с потребителите на линия, трябва да сте влезли в профила си.',
	...
	'MCP_SHORT'				=> 'Модераторски контролен панел',
	'MEMBERLIST'			=> 'Потребители',
	'MEMBERLIST_EXPLAIN'	=> 'Разгледай пълния списък на потребителите',
	'MERGE'					=> 'Съедини',
	'MERGE_POSTS'			=> 'ремести мненията',
	'MERGE_TOPIC'			=> 'Съедини с тема',
	'MESSAGE'				=> 'Съобщение',
	'MESSAGES'				=> 'Съобщения',
	...
	'MODULE_NOT_FIND'		=> 'Модулът %s не може да бъде намерен',
	'MODULE_FILE_INCORRECT_CLASS'	=> 'Файлът за модул %s не съдържа правилен клас [%s]',
	'MONTH'					=> 'Месец',
	'MOVE'					=> 'Премести',
	...
	'NOT_WATCHING_FORUM'		=> 'Вече не следите този форум.',
	'NOT_WATCHING_TOPIC'		=> 'Вече не следите тази тема.',
	...
	'NOTIFICATION_BOOKMARK'				=> array(
		1	=> '<strong>Отговори</strong> от %1$s в тема, която следите::',
	),
	...
	'NOTIFICATION_METHOD_INVALID'		=> 'Методът "%s" не е валиден метод за известяване.',
	...
	'NOTIFICATION_TYPE_NOT_EXIST'		=> 'Типът известие "%s" липсва във файловата система.',
	...
	'NO_ACCESS_ATTACHMENT'		=> 'Нямате право да достъпите този файл.',
	...
	'NO_EMAIL_MESSAGE'			=> 'Мейл съобщението беше празно.',
	'NO_EMAIL_RESPONSE_CODE'	=> 'Няма отговор от мейл сървъра.',
	'NO_EMAIL_SUBJECT'			=> 'Полето за зазаглавие на мейла е празно.',
	'NO_FORUM'					=> 'Форумът, който избрахте, не съществува.',
	'NO_FORUMS'					=> 'Няма създадени форуми.',
	'NO_GROUP'					=> 'Избраната потребителска група не съществува.',
	'NO_GROUP_MEMBERS'			=> 'Тази група няма членове.',
	'NO_IPS_DEFINED'			=> 'Няма дефинирани IP адреси или имена',
	...
	'NO_NEW_POSTS'				=> 'Няма нови публикации',	// Not used anymore
	...
	'NO_FEED_ENABLED'			=> 'Няма фийдове за този форум.',
	'NO_FEED'					=> 'Посоченият фийд не е достъпен.',
	'NO_STYLE_DATA'				=> 'Липсва оформление.',
	'NO_SUBJECT'				=> 'Няма заглавие',								// Used for posts having no subject defined but displayed within management pages.
	'NO_SUCH_SEARCH_MODULE'		=> 'Избраният модул за търсене не съществува.',
	...
	'NO_UPLOAD_FORM_FOUND'		=> 'Качването бе стартирано, но липсва съответна форма, която е валидна.',
	'NO_USER'					=> 'Посоченият потребител не съществува.',
	'NO_USERS'					=> 'Посочените потребители не съществуват.',
	'NO_USER_SPECIFIED'			=> 'Не е посочено потребителско име.',
	...
	'SEARCH_ADV_EXPLAIN'		=> 'Вижте опциите за разширено търсене',
	...
	'SEND_EMAIL'				=> 'Изпрати мейл',				// Used for submit buttons
	'SEND_EMAIL_USER'			=> 'Изпрати мейл до %s',
	...
	'SORRY_AUTH_READ_TOPIC'		=> 'Нямате право да четете тази тема.',
	'SORRY_AUTH_VIEW_ATTACH'	=> 'Нямате право да свалите този прикачен файл.',
	'SORT_BY'					=> 'Сортирай по',
	'SORT_DIRECTION'			=> 'Ред',
	'SORT_JOINED'				=> 'Дата на регистрация',
	'SORT_LOCATION'				=> 'Местоположение',
	'SORT_OPTIONS'				=> 'Настройки на подредбатаа',
	'SORT_RANK'					=> 'Ранг',
	'SORT_POSTS'				=> 'Мнения',
	'SORT_TOPIC_TITLE'			=> 'Заглавие на темата',
	'SORT_USERNAME'				=> 'Потребителско име',
	'SPLIT_TOPIC'				=> 'Раздели темата',
	'SQL_ERROR_OCCURRED'		=> 'Възникна SQL грешка при извикването на тази страница. Моля, свържете се с %sBoard Administrator%s, ако проблемът продължи.',
	...
	'TOO_LONG_EMAIL'				=> 'Мейлът, който въведохте, е твърде дълъг.',
	...
	'TOO_SHORT_EMAIL'				=> 'Мейл адресът, който въведохте, е твърде къс.',
	'TOO_SHORT_EMAIL_CONFIRM'		=> 'Потвърждението на мейл адреса, който въведохте, е твърде късо.',
	...
	'UNWATCH_FORUM_CONFIRM'		=> 'Наистина ли искате да прекратите абонамента си за този форум?',
	'UNWATCH_FORUM_DETAILED'	=> 'Наистина ли искате да прекратите абонамента си за форума „%s“?',
	'UNWATCH_TOPIC_CONFIRM'		=> 'Наистина ли искате да прекратите абонамента си за тази тема?',
	'UNWATCH_TOPIC_DETAILED'	=> 'Наистина ли искате да прекратите абонамента си за темата „%s“?',
	...
	'URL_REDIRECT'			=> 'Ако браузърът Ви не поддържа meta redirects, %splease click HERE to be redirected%s.',
	'USERGROUPS'			=> 'Групи',
	...
	'USERS'					=> 'Потребители',
	'USE_PERMISSIONS'		=> 'Тест на потребителските настройки и права',

	'USER_NEW_PERMISSION_DISALLOWED'	=> 'Съжаляваме, но тази функция още не е достъпна за Вас. Възможно е да сте регистрирали скоро и ще трябва да участвате по-дълго, за да можете да използвате тази функция.',
	...
	'VIEW_ONLINE_TIMES'			=> array(
		1	=> 'въз основа на активните потребители в последната %d минута',
		2	=> 'въз основа на активните потребители в последните %d минути',
	),
	...
	'WATCH_FORUM_CONFIRM'	=> 'Наистина ли искате да се абонирате за този форум?',
	'WATCH_FORUM_DETAILED'	=> 'Наистина ли искате да се абонирате за форума „%s“?',
	'WATCH_TOPIC_CONFIRM'	=> 'Наистина ли искате да се абонирате за тази тема?',
	'WATCH_TOPIC_DETAILED'	=> 'Наистина ли искате да се абонирате за темата „%s“?',
	...
	'dateformats'	=> array(
		'd M Y, H:i'			=> '01 ян 2007, 13:37',
		'd M Y H:i'				=> '01 ян 2007 13:37',
		'M jS, \'y, H:i'		=> 'ян първи, \'07, 13:37',
		'D M d, Y g:i a'		=> 'пон ян 01, 2007 1:37 pm',
		'F jS, Y, g:i a'		=> 'януари първи, 2007, 1:37 pm',
		'|d M Y|, H:i'			=> 'Днес, 13:37 / 01 ян 2007, 13:37',
		'|F jS, Y|, g:i a'		=> 'Днес, 1:37 pm / януари 1st, 2007, 1:37 pm',
	),

	// The default dateformat which will be used on new installs in this language
	// Translators should change this if a the usual date format is different
	'default_dateformat'	=> 'D M d, Y g:i a', //  Пон, 01 Ян 2007, 13:37
